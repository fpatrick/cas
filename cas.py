...
def start():
    ...
    print()
    print("***********************************************************************")
    print("*              Welcome to CaS - Command and Script v1.0.0             *")
...
def make_file(user_folder, user_command):
    ...
    try:
        ...
        with open(f_path, 'w') as f:
            ...
            f.write('    print(f"{dt_string}: ' + script_name + '.lock found, the command is still running. Delete lock file to force run.")\n')
            f.write('else:\n')
...
# If choice is to create a script
    ...
    print("> *!* ATTENTION *!* recreate the script if you need to move it to another folder!!! \n\n")
